...
export const MeetingList = (meetingListProp: MeetingListProps) => {
    ...
    return (
        <>
            {filteredMeetings
                .map((element: MeetingEntry) => {
                    return (
                        <Grid key={element.id} item xs={3}>
                            <Card sx={{ minWidth: 275, boxShadow: '0 3px 6px #00000029' }}>
                                <CardContent>
                                    <Typography sx={{ fontSize: 20, fontWeight: 'bold', color: '#1976D2' }} color="text.secondary" gutterBottom align="center">
                                        {
                                    ...
                                    <Typography sx={{ fontSize: 17, fontWeight: 'bold', color: '#4A6072' }} component="div" align="center">
                                        {element.title}
                                    </Typography>
